...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=22&duration=2500&pause=900&center=true&vCenter=true&width=650&lines=DIGITAL+HARDWARE;RTL+%7C+FPGA+%7C+VLSI;COMMUNICATION+SYSTEMS;CURRENTLY+DEBUGGING..." alt="Typing SVG">

<br>

`RTL` · `SystemVerilog` · `FPGA` · `VLSI` · `Digital Design`
...
<div align="center">
CONTRIBUTION MATRIX
<picture> <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Tin-card/Tin-card/output/github-contribution-grid-snake-dark.svg">

<source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Tin-card/Tin-card/output/github-contribution-grid-snake.svg">
